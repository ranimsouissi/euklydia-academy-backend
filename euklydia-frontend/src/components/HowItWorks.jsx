...
const steps = [
  {
    step: "01",
    title: "Assess",
    desc: "Get a clear maturity score, skill gaps, and readiness insights across your role's focus areas.",
    icon: (
    ...
    detail: "10 min · 10 questions · 5 skills × 2 questions · Role-personalized",
  },
  {
    step: "02",
    title: "Prioritize",
    desc: "Get your personalized roadmap instantly — built for 30 to 90 days of focused execution, aligned to your business goals.",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="#006355" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
      </svg>
    ),
    detail: "Skill priorities · Learning sequence · Business alignment",
  },
  {
    step: "03",
    title: "Execute",
    desc: "Follow role-based modules with frameworks, exercises, and deliverables that drive real adoption.",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="#006355" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
      </svg>
    ),
    detail: "Role-specific modules · Templates · Real deliverables",
  },
];
...
export default function HowItWorks() {
  return (
    <Section id="how" bg="#F2FBF9">
      <SectionHeader
        kicker="How it works ?"
        title="A simple path from assessment to business impact"
      />
      ...
      >
        {steps.map((s, idx) => (
          <>
            ...
            {idx < steps.length - 1 && (
              <div key={`arrow-${idx}`} style={{ padding: "0 8px", marginTop: 60 }}>
                <Arrow />
              </div>
            )}
          </>
