...
export default function DashboardPage() {
  ...
  const key = Object.keys(ROLE_DETAILS).find(
    k => k.toLowerCase().trim() === String(userRole).toLowerCase().trim()
  );
  return key ? ROLE_DETAILS[key] : null;
}, [userRole]);
  ...
  const interventionLabel = type => {
    ...
    if (type === "read_resource") return "Lire la ressource";
    return type;
  };
