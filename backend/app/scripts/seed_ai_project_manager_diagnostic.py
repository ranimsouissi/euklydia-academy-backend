"""
Seed AI Project Manager — Diagnostic (refactoré v1.1)

Charge le contenu depuis content/diagnostics/ai_project_manager.json
...
Source de vérité : PDF Parcours AI Project Manager v1.1 — Mai 2026 — Ranim Souissi.
...
le fichier JSON content/diagnostics/ai_project_manager.json. Ce script
...
def seed_ai_project_manager_diagnostic(db):
    """
    Seed les 3 skills + 9 questions du diagnostic AI Project Manager.

    Lit le contenu depuis content/diagnostics/ai_project_manager.json.
    Idempotent : skip si déjà seedé.
    """
    # =========================================================================
    ...
    print(
        f"✅ AI Project Manager seedé (depuis JSON) : "
