"""
Seed AI Sales Specialist — Diagnostic (refactoré v1.1)

Charge le contenu depuis content/diagnostics/ai_sales_specialist.json
...
Source de vérité : PDF Parcours AI Sales Specialist v1.1 — Mai 2026.
...
le fichier JSON content/diagnostics/ai_sales_specialist.json. Ce script ne
contient plus que la logique d'insertion BDD.
"""
...
ROLE_SLUG = "ai_sales_specialist"


def seed_ai_sales_specialist_diagnostic(db):
    """
    Seed les 3 skills + 9 questions du diagnostic AI Sales Specialist.

    Lit le contenu depuis content/diagnostics/ai_sales_specialist.json.
    Idempotent : skip si déjà seedé.
    """
    # =========================================================================
    ...
    print(
        f"✅ AI Sales Specialist seedé (depuis JSON) : "
