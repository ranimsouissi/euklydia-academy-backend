"""
Seed AI Designer — Diagnostic (refactoré v1.1)

Charge le contenu depuis content/diagnostics/ai_designer.json
(architecture Option 3 — JSON externe comme source de vérité).

Contenu pédagogique du diagnostic AI Designer :
- 3 skills (logique 1 skill = 1 module)
- 9 questions QCM (3 par skill : Connaissance / Application / Maîtrise)

Source de vérité : PDF Parcours AI Designer v1.1 — Mai 2026.

Career path : AI Designer (id=81).

Idempotent : skip si déjà seedé.

Refactor : le contenu pédagogique (SKILLS, QUESTIONS) est externalisé dans
le fichier JSON content/diagnostics/ai_designer.json. Ce script
...
def seed_ai_designer_diagnostic(db):
    """
    Seed les 3 skills + 9 questions du diagnostic AI Designer.

    Lit le contenu depuis content/diagnostics/ai_designer.json.
    Idempotent : skip si déjà seedé.
    """
    # =========================================================================
    ...
    print(
        f"✅ AI Designer seedé (depuis JSON) : "
